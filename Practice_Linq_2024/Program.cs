...
namespace Practice_Linq_2024
{
    internal class Program
    {
        ...
        static void Query6(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => g.Tournament == "FIFA World Cup" && g.Date.Year == 2022)
                .OrderByDescending(g => g.Date).Take(8);
        ...
        static void Query7(List<FootballGame> games)
        {
            ...
            var selectedGame = games.Where(g => g.Date.Year == 2023 &&
                    ((g.Home_team == "Ukraine" && g.Home_score > g.Away_score) ||
                     (g.Away_team == "Ukraine" && g.Away_score > g.Home_score))).OrderBy(g => g.Date).FirstOrDefault();
        ...
        static void Query9(List<FootballGame> games)
        {
            ...
            var transformedGames = games.Where(g => g.Tournament == "UEFA Nations League" && g.Date.Year == 2023)
                .Select(g => new
                {
                    MatchYear = g.Date.Year,
        ...
        static void Query10(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => g.Tournament == "Gold Cup" && g.Date.Year == 2023 && g.Date.Month == 7).Skip(4).Take(6);
